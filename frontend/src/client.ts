...
export function Environment(name: string): BaseURL {
    return `https://${name}-meeting-notes-o6e2.encr.app`
}
...
/**
 * Client is an API client for the meeting-notes-o6e2 Encore application.
 */
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "meeting-notes-o6e2-Generated-TS-Client (Encore/v1.42.1)";
        }
